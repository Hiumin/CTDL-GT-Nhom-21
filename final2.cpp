...
void menuNhanvien(Linkedlist &H);
...
// ham kiem tra mat khau cua nhan vien
void matkhau(billlist &J, Listbill &L, Listbill &temp, long &doanhthu, listnv* &K, Linkedlist &H){
    long pass;
    bool found = false;
    char escape;
    if (K == NULL) {
        ...
        cout << "Nhap 1 ky tu bat ky de thoat ra, 2 de truy cap quan ly nhan vien: ";
        cin >> escape;
        if(escape == '2'){
            menuNhanvien(H);
            return;
